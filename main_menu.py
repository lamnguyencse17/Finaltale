...
class Menu(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.game_title_rect = game_title.get_rect(center=(center[0], center[1]-50))
        ...
        self.play_title_rect = play_title.get_rect(
            center=[play_title_pos[0] + play_title.get_width() / 2, play_title_pos[1]+100])
        ...
        self.option_title_rect = option_title.get_rect(
            center=[option_title_pos[0] + option_title.get_width() / 2, option_title_pos[1]+150])
        ...
        self.quit_title_rect = quit_title.get_rect(
            center=[quit_title_pos[0] + quit_title.get_width() / 2, quit_title_pos[1]+200])
    ...
    def is_play_title_clicked(self):
        mouse_pos = pg.mouse.get_pos()
        print(self.play_title_rect.x, self.play_title_rect.y)
        print(mouse_pos)
        print()
